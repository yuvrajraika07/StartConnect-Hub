    ...
    <div className="footer">
      <div className="footer-container footer-container-md">
        <div className="footer-1">
         ...
         <a href="#" className="star-us">Star us ⭐</a>
        ...
        <div className="footer-half footer-sections">
          ...
          <div className="footer-2">
            ...
            <div className="footer-icons footer-icons-md">
              <a href="https://www.linkedin.com/in/yuvrajkhatanaraika01/" target="_blank" rel="noreferrer">
                <FaLinkedin style={{ fontSize: "25px"}} />
              </a>
              <a href="https://github.com/yuvrajraika07" target="_blank" rel="noreferrer">
                <FaGithub style={{ fontSize: "25px"}} />
              </a>
              <a href="https://facebook.com" target="_blank" rel="noreferrer">
                <FaFacebook style={{ fontSize: "25px"}} />
              </a>
              <a href="https://x.com/RaikaYuvraj" target="_blank" rel="noreferrer">
  <img src={twitterIcon} alt="Twitter" style={{ width: "20px", height: "20px"}} />
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-link">
          &copy; {new Date().getFullYear()} yuvrajraika. All rights reserved.
        </div>
      </div>
    </div>
  );
